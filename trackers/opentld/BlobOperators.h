...
class CBlobGetExternPerimeter: public COperadorBlob {
  public:
    ...
    CBlobGetExternPerimeter( IplImage *mask, bool xBorder = true,
                             bool yBorder = true ) {
        m_mask = mask;
        m_xBorder = xBorder;
        m_yBorder = yBorder;
...
class CBlobGetExternPerimeterRatio: public COperadorBlob {
  public:
    ...
    CBlobGetExternPerimeterRatio( IplImage *mask, bool xBorder = true,
                                  bool yBorder = true ) {
        m_mask = mask;
        m_xBorder = xBorder;
        m_yBorder = yBorder;
...
class CBlobGetExternHullPerimeterRatio: public COperadorBlob {
  public:
    ...
    CBlobGetExternHullPerimeterRatio( IplImage *mask, bool xBorder = true,
                                      bool yBorder = true ) {
        m_mask = mask;
        m_xBorder = xBorder;
        m_yBorder = yBorder;
